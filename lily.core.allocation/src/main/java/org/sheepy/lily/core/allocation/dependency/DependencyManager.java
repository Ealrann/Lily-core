...
public final class DependencyManager
{
	...
	public static final class Builder
	{
		...
		public DependencyManager build(final IFeaturedObject target,
		...
		private List<DependencyWatcher.Builder> filterCriticalDependencies(final IFeaturedObject target,
																		   final List<DependencyUpdater.Builder> updatableDependencies)
		{
		...
		private List<DependencyUpdater.Builder> gatherUpdatableDependencies(final IFeaturedObject target,
																			final IAdapterDescriptor.ExtenderContext<?> extenderContext)
		{
		...
		private DependencyUpdater.Builder newDependencyUpdater(final IFeaturedObject target,
