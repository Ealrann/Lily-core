...
/**
 * This is the item provider adapter for a {@link org.sheepy.lily.core.model.ui.TextWidget} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		IItemPropertySource
{
	...
	protected void addFontPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TextWidget_font_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TextWidget_font_feature", "_UI_TextWidget_type"),
				 UiPackage.Literals.TEXT_WIDGET__FONT,
				 true,
				 false,
				 true,
				 null,
	...
	{
		Vector2ic labelValue = ((TextWidget)object).getPosition();
