 ...
 * @generated
 */
public class IntVariableItemProvider extends IModelVariableItemProvider
{
	/**
	...
	{
		IntVariable intVariable = (IntVariable)object;
		return getString("_UI_IntVariable_type") + " " + intVariable.getValue();
	}
