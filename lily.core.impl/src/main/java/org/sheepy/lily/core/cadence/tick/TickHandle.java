...
public final class TickHandle
{
	...
	private LongConsumer tickOperation(final IAdapterHandle.AnnotatedHandle<Tick> tickAnnotatedHandle)
	{
		...
		{
			@SuppressWarnings("unchecked") final var oConsumer = (Consumer<Object>) function;
		...
		{
			@SuppressWarnings("unchecked") final var oLongConsumer = (ObjLongConsumer<Object>) function;
	...
	public static final class Builder
	{
		...
		public boolean isApplicable(LMObject target)
		{
			return descriptor.isApplicable(target);
		}

		public TickHandle build(LMObject target)
		{
