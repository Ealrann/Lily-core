...
public final class MaintainerUtil
{
	...
	public static <T extends Maintainable<T>> T instanciateMaintainer(Maintainer<T> maintainer, boolean resolve)
	{
		...
		final var featureCopier = new FeatureCopier(resolve);
		featureCopier.copyFeatures(maintainer, res, maintainedEClass.getEAllStructuralFeatures());
