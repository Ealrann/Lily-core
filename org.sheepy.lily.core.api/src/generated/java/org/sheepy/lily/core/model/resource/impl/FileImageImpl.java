	...
	public FileResource getFile()
	{
		if (file != null && ((EObject)file).eIsProxy())
		{
			...
			if (file != oldFile)
			{
				...
				NotificationChain msgs = oldFile.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ResourcePackage.FILE_IMAGE__FILE, null, null);
				if (newFile.eInternalContainer() == null)
				{
					msgs = newFile.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ResourcePackage.FILE_IMAGE__FILE, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ResourcePackage.FILE_IMAGE__FILE, oldFile, file));
			}
		}
		return file;
	}
