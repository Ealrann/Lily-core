 ...
 * <!-- end-user-doc -->
 * @see org.sheepy.lily.core.model.types.TypesPackage#getEDirection()
 * @model
 * @generated
 */
public enum EDirection implements Enumerator
{
	 ...
	 * @generated
	 */
	public static final List<EDirection> VALUES = Collections
	 ...
	 * @generated
	 */
	public static EDirection get(String literal)
	{
		for (int i = 0; i < VALUES_ARRAY.length; ++i)
		{
			EDirection result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static EDirection getByName(String name)
	{
		for (int i = 0; i < VALUES_ARRAY.length; ++i)
		{
			EDirection result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static EDirection get(int value)
	{
		switch (value)
		{
		case UP_VALUE:
	 ...
	 * @generated
	 */
	private EDirection(int value, String name, String literal)
	{
		this.value = value;
		this.name = name;
