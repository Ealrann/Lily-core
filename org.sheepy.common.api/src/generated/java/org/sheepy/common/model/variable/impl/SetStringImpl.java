...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Set String</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.sheepy.common.model.variable.impl.SetStringImpl#getVariableResolver <em>Variable Resolver</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetStringImpl extends ActionImpl implements SetString
{
	/**
	...
	{
		return VariablePackage.Literals.SET_STRING;
	}
	...
	public NotificationChain basicSetVariableResolver(AbstractVariableResolver newVariableResolver, NotificationChain msgs)
	{
		...
		{
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, VariablePackage.SET_STRING__VARIABLE_RESOLVER, oldVariableResolver, newVariableResolver);
	...
	public void setVariableResolver(AbstractVariableResolver newVariableResolver)
	{
		if (newVariableResolver != variableResolver)
		{
			...
			if (variableResolver != null)
				msgs = ((InternalEObject)variableResolver).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - VariablePackage.SET_STRING__VARIABLE_RESOLVER, null, msgs);
			if (newVariableResolver != null)
				msgs = ((InternalEObject)newVariableResolver).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - VariablePackage.SET_STRING__VARIABLE_RESOLVER, null, msgs);
			msgs = basicSetVariableResolver(newVariableResolver, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, VariablePackage.SET_STRING__VARIABLE_RESOLVER, newVariableResolver, newVariableResolver));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == VarChangeAction.class)
		{
			...
			{
				case VariablePackage.SET_STRING__VARIABLE_RESOLVER: return VariablePackage.VAR_CHANGE_ACTION__VARIABLE_RESOLVER;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == VarChangeAction.class)
		{
			...
			{
				case VariablePackage.VAR_CHANGE_ACTION__VARIABLE_RESOLVER: return VariablePackage.SET_STRING__VARIABLE_RESOLVER;
				default: return -1;
			}
		}
