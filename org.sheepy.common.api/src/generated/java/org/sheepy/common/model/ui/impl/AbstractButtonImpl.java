...
public abstract class AbstractButtonImpl extends MinimalEObjectImpl.Container implements AbstractButton
{
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
	{
		if (baseClass == IRelativeElement.class)
		{
			...
			{
				case UiPackage.ABSTRACT_BUTTON__VERTICAL_RELATIVE: return PresentationPackage.IRELATIVE_ELEMENT__VERTICAL_RELATIVE;
				case UiPackage.ABSTRACT_BUTTON__HORIZONTAL_RELATIVE: return PresentationPackage.IRELATIVE_ELEMENT__HORIZONTAL_RELATIVE;
				default: return -1;
			}
		}
		if (baseClass == ISizedElement.class)
		{
			switch (derivedFeatureID)
			{
				case UiPackage.ABSTRACT_BUTTON__POSITION: return PresentationPackage.ISIZED_ELEMENT__POSITION;
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
	{
		if (baseClass == IRelativeElement.class)
		{
			...
			{
				case PresentationPackage.IRELATIVE_ELEMENT__VERTICAL_RELATIVE: return UiPackage.ABSTRACT_BUTTON__VERTICAL_RELATIVE;
				case PresentationPackage.IRELATIVE_ELEMENT__HORIZONTAL_RELATIVE: return UiPackage.ABSTRACT_BUTTON__HORIZONTAL_RELATIVE;
				default: return -1;
			}
		}
		if (baseClass == ISizedElement.class)
		{
			switch (baseFeatureID)
			{
				case PresentationPackage.ISIZED_ELEMENT__POSITION: return UiPackage.ABSTRACT_BUTTON__POSITION;
